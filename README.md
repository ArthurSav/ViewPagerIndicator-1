...
This project is a fork of the original [ViewPagerIndicator library](https://github.com/JakeWharton/ViewPagerIndicator) by JakeWharton.
This fork updated the library to use gradle and updated the dependencies to get ready for AndroidX.
